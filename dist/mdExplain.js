 ...
 * @param {string} str
 */
export function interpretMd(str) {
    var arr = str.split(['\n']);
    var n = 0, iter = createNum();
    for (var prop in arr) {
        // console.log(prop)
        var item = arr[prop], num = -1;
        // 多级标题
        if (/^#/.test(item)) {
...
//# sourceMappingURL=mdExplain.js.map